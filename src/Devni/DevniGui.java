 ...
 * @author it15-102560
 */
public class DevniGui extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DevniGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
