...
public class Course_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(160, 160, 100, 20);

        jButton3.setText("View Course Details");
        jPanel2.add(jButton3);
        jButton3.setBounds(100, 260, 160, 40);

        jButton4.setText("View Available Courses");
        jPanel2.add(jButton4);
        jButton4.setBounds(360, 260, 160, 40);
        ...
        jScrollPane1.setBounds(360, 110, 440, 90);
        jPanel2.add(jTextField2);
        jTextField2.setBounds(160, 110, 100, 20);
