...
public class User_LogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(190, 140, 90, 20);
        jPanel2.add(jTextField3);
        jTextField3.setBounds(190, 180, 90, 20);

        jLabel5.setText("Password");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(80, 170, 70, 30);
        ...
        jButton3.setBounds(70, 270, 100, 40);

        jButton4.setText("Cancel");
        jPanel2.add(jButton4);
        jButton4.setBounds(230, 270, 90, 40);

        jLabel15.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel15.setText("User LogIn");
        jPanel2.add(jLabel15);
        jLabel15.setBounds(80, 60, 140, 30);
