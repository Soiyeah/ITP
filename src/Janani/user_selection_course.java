 ...
 * @author it15-102560
 */
public class user_selection_course extends javax.swing.JFrame {

    /**
     * Creates new form gui
     */
    public user_selection_course() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please select a user type ");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(70, 100, 270, 60);

        jButton5.setText("Lecturer");
        jPanel2.add(jButton5);
        jButton5.setBounds(270, 230, 100, 50);

        jButton6.setText("Student");
        jPanel2.add(jButton6);
        jButton6.setBounds(480, 230, 100, 50);

        jButton7.setText("Administrator");
        jPanel2.add(jButton7);
        jButton7.setBounds(70, 230, 100, 50);
