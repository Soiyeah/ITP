 ...
 * @author it15-102560
 */
public class Hall_Type_Selection extends javax.swing.JFrame {

    /**
     * Creates new form gui
     */
    public Hall_Type_Selection() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton5.setText("Practical Hall");
        jPanel2.add(jButton5);
        jButton5.setBounds(360, 170, 150, 50);

        jButton6.setBackground(new java.awt.Color(0, 102, 102));
        jButton6.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jButton6.setForeground(new java.awt.Color(0, 153, 153));
        jButton6.setText("Lecture Hall");
        jPanel2.add(jButton6);
        jButton6.setBounds(110, 170, 180, 50);

        jLabel1.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jLabel1.setText("Please select the hall type");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(110, 110, 320, 30);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hall_Type_Selection().setVisible(true);
            }
        });
    }
