 ...
 * @author it15-102560
 */
public class Hall_management extends javax.swing.JFrame {

    /**
     * Creates new form gui
     */
    public Hall_management() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Hall Type Selection");
        jLabel11.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        jLabel12.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Hall Arrangements");
        ...
        jTextField1.setBounds(130, 100, 70, 20);

        jLabel9.setText("Duration(To) ");
        jPanel2.add(jLabel9);
        jLabel9.setBounds(50, 260, 64, 14);

        jLabel14.setText("Date (Year)");
        jLabel14.setToolTipText("");
        jPanel2.add(jLabel14);
        jLabel14.setBounds(50, 100, 56, 14);

        jLabel4.setText("Duration (from) ");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(50, 220, 77, 14);

        jLabel15.setText("Date (Month)");
        jLabel15.setToolTipText("");
        jPanel2.add(jLabel15);
        jLabel15.setBounds(50, 140, 64, 14);

        jLabel16.setText("Date (Date)");
        jLabel16.setToolTipText("");
        jPanel2.add(jLabel16);
        jLabel16.setBounds(50, 180, 57, 14);
        ...
        jTextField3.setBounds(130, 140, 70, 20);
        ...
        jTextField4.setBounds(130, 180, 70, 20);
        ...
        jTextField5.setBounds(130, 220, 70, 20);
        ...
        jTextField6.setBounds(130, 260, 70, 20);
        ...
        jTextField7.setBounds(130, 60, 70, 20);

        jLabel5.setText("Availability");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(50, 320, 51, 14);

        jButton4.setText("Reset");
        jPanel2.add(jButton4);
        jButton4.setBounds(50, 440, 61, 23);

        jButton8.setText("Delete");
        jPanel2.add(jButton8);
        jButton8.setBounds(130, 440, 63, 23);

        jButton7.setText("Update");
        jPanel2.add(jButton7);
        jButton7.setBounds(130, 390, 67, 23);

        jButton3.setText("Book");
        jPanel2.add(jButton3);
        jButton3.setBounds(50, 390, 55, 23);

        jButton9.setBackground(new java.awt.Color(24, 185, 175));
        jButton9.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jButton9.setForeground(new java.awt.Color(0, 102, 102));
        jButton9.setText("Search halls");
        jButton9.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel2.add(jButton9);
        jButton9.setBounds(520, 290, 160, 23);

        jButton5.setText("View Schedule");
        jPanel2.add(jButton5);
        jButton5.setBounds(360, 60, 130, 30);
        ...
        jScrollPane1.setBounds(360, 120, 430, 90);

        jLabel17.setText("Hall No");
        jPanel2.add(jLabel17);
        jLabel17.setBounds(370, 250, 70, 20);

        jLabel18.setText("Capacity");
        jPanel2.add(jLabel18);
        jLabel18.setBounds(370, 290, 90, 30);

        jTextField9.setMinimumSize(new java.awt.Dimension(5, 20));
        jTextField9.setOpaque(false);
        jTextField9.setPreferredSize(new java.awt.Dimension(5, 20));
        jPanel2.add(jTextField9);
        jTextField9.setBounds(440, 290, 80, 23);

        jTextField10.setMinimumSize(new java.awt.Dimension(5, 20));
        jTextField10.setOpaque(false);
        jTextField10.setPreferredSize(new java.awt.Dimension(5, 20));
        jPanel2.add(jTextField10);
        jTextField10.setBounds(120, 320, 110, 23);
        ...
        jButton10.setBounds(230, 320, 75, 23);

        jTextField11.setMinimumSize(new java.awt.Dimension(5, 20));
        jTextField11.setOpaque(false);
        jTextField11.setPreferredSize(new java.awt.Dimension(5, 20));
        jPanel2.add(jTextField11);
        jTextField11.setBounds(440, 250, 80, 23);

        jButton11.setBackground(new java.awt.Color(24, 185, 175));
        jButton11.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jButton11.setForeground(new java.awt.Color(0, 102, 102));
        jButton11.setText("Search availability ");
        jButton11.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel2.add(jButton11);
        jButton11.setBounds(520, 250, 160, 23);

        jButton6.setText("Back");
        jPanel2.add(jButton6);
        jButton6.setBounds(540, 430, 55, 23);

        jButton12.setText("Close");
        jPanel2.add(jButton12);
        jButton12.setBounds(630, 430, 59, 23);

        jButton13.setText("Home");
        jPanel2.add(jButton13);
        jButton13.setBounds(760, 30, 59, 23);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hall_management().setVisible(true);
            }
        });
    }
